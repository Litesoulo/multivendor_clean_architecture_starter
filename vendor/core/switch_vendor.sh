...
sed -i "/package/c\package $androidPackage" $newDirectory/MainActivity.kt
## Android Debug AndroidManifest
sed -i "/package=/c\    package=\"$androidPackage\">" android/app/src/debug/AndroidManifest.xml
## Android Main AndroidManifest
sed -i "/package=/c\    package=\"$androidPackage\">" android/app/src/main/AndroidManifest.xml
sed -i "/<activity/{n;s/.*/            android:name=\"$androidPackage.MainActivity\"/}" android/app/src/main/AndroidManifest.xml
## Android Profile AndroidManifest
sed -i "/package=/c\    package=\"$androidPackage\">" android/app/src/profile/AndroidManifest.xml
## Android Gradle ApplicationId
sed -i "/applicationId/c\        applicationId \"$androidPackage\"" android/app/build.gradle
#
...
#
sed -i "/PRODUCT_BUNDLE_IDENTIFIER/c\				PRODUCT_BUNDLE_IDENTIFIER = $iosBundleID;" ios/Runner.xcodeproj/project.pbxproj
#
...
#
sed -i "/set(APPLICATION_ID \"/c\set(APPLICATION_ID \"$linuxApplicationId\")" linux/CMakeLists.txt
#
...
#
sed -i "/PRODUCT_BUNDLE_IDENTIFIER/c\PRODUCT_BUNDLE_IDENTIFIER = $macosBundleId" macos/Runner/Configs/AppInfo.xcconfig
sed -i "/PRODUCT_BUNDLE_IDENTIFIER/c\				PRODUCT_BUNDLE_IDENTIFIER = $macosBundleId.RunnerTests;" macos/Runner.xcodeproj/project.pbxproj
#
...
#
sed -i "/VALUE \"CompanyName\", \"/c\            VALUE \"CompanyName\", \"$windowsCompanyName\" \"\0\"" windows/runner/Runner.rc
#
...
#
## Android Main AndroidManifest
sed -i "/android:label=/c\        android:label=\"$applicationName\"" android/app/src/main/AndroidManifest.xml
## iOS Info.plist
sed -i "/<key>CFBundleDisplayName<\/key>/{n;s/<string>.*<\/string>/<string>$applicationName<\/string>/}" ios/Runner/Info.plist
sed -i "/<key>CFBundleName<\/key>/{n;s/<string>.*<\/string>/<string>$applicationName<\/string>/}" ios/Runner/Info.plist
## Linux
sed -i "/set(BINARY_NAME \"/c\set(BINARY_NAME \"$applicationName\")" linux/CMakeLists.txt
sed -i "/gtk_header_bar_set_title(header_bar, \"/c\    gtk_header_bar_set_title(header_bar, \"$applicationName\");" linux/my_application.cc
sed -i "/gtk_window_set_title(window, \"/c\    gtk_window_set_title(window \"$applicationName\");" linux/my_application.cc
## Macos
sed -i "/PRODUCT_NAME/c\PRODUCT_NAME = $applicationName" macos/Runner/Configs/AppInfo.xcconfig
## Web
sed -i "/<meta name=\"apple-mobile-web-app-title\" content=\"/c\  <meta name=\"apple-mobile-web-app-title\" content=\"$applicationName\">" web/index.html
sed -i "/<title>/c\  <title>$applicationName</title>" web/index.html
sed -i "/    \"name\": /c\    \"name\": \"$applicationName\"," web/manifest.json
sed -i "/    \"short_name\": /c\    \"short_name\": \"$applicationName\"," web/manifest.json
## Windows
sed -i "/project(\"/c\project($applicationName LANGUAGES CXX)" windows/CMakeLists.txt
sed -i "/set(BINARY_NAME \"/c\set(BINARY_NAME \"$applicationName\")" windows/CMakeLists.txt
sed -i "/if (!window.Create(L\"/c\  if (!window.Create(L\"$applicationName\", origin, size)) {" windows/runner/main.cpp
sed -i "/VALUE \"FileDescription\", \"/c\            VALUE \"FileDescription\", \"$applicationName\" \"\0\"" windows/runner/Runner.rc
sed -i "/VALUE \"InternalName\", \"/c\            VALUE \"InternalName\", \"$applicationName\" \"\0\"" windows/runner/Runner.rc
sed -i "/VALUE \"OriginalFilename\", \"/c\            VALUE \"OriginalFilename\", \"$applicationName.exe\" \"\0\"" windows/runner/Runner.rc
sed -i "/VALUE \"ProductName\", \"/c\            VALUE \"ProductName\", \"$applicationName\" \"\0\"" windows/runner/Runner.rc
#
...
sed -i "${splashColorIndex}s/.*/  color: \"$splashColor\"/" flutter_native_splash.yaml
sed -i "${splashColorDarkIndex}s/.*/  color_dark: \"$splashColorDark\"/" flutter_native_splash.yaml
## Background
...
sed -i "${splashColorAndroid12Index}s/.*/    color: \"$splashColorAndroid12\"/" flutter_native_splash.yaml
sed -i "${splashColorAndroid12DarkIndex}s/.*/    color_dark: \"$splashColorAndroid12Dark\"/" flutter_native_splash.yaml
## Android 12 # Logo Background Color
sed -i "/icon_background_color=/c\  icon_background_color: \"$splashIconColorAndroid12\"/" flutter_native_splash.yaml
sed -i "/icon_background_color_dark=/c\  icon_background_color_dark: \"$splashIconColorAndroid12Dark\"/" flutter_native_splash.yaml
## Android 12 # Logo
...
# sed -i "/facebook_app_id/c\    <string name=\"facebook_app_id\">$facebookApplicationId</string>" android/app/src/main/res/values/strings.xml
# sed -i "/facebook_client_token/c\    <string name=\"facebook_client_token\">$facebookClientToken</string>" android/app/src/main/res/values/strings.xml
# ## iOS Info.plist
# sed -i "/fb/c\                     <string>fb${facebookApplicationId}</string>" ios/Runner/Info.plist
# sed -i "/<key>FacebookAppID<\/key>/{n;s/<string>.*<\/string>/<string>$facebookApplicationId<\/string>/}" ios/Runner/Info.plist
# sed -i "/<key>FacebookClientToken<\/key>/{n;s/<string>.*<\/string>/<string>$facebookClientToken<\/string>/}" ios/Runner/Info.plist
# sed -i "/<key>FacebookDisplayName<\/key>/{n;s/<string>.*<\/string>/<string>$applicationName<\/string>/}" ios/Runner/Info.plist
# #
...
# #
# sed -i "/freshchat_file_provider_authority/c\    <string name=\"freshchat_file_provider_authority\">$androidPackage.provider</string>" android/app/src/main/res/values/strings.xml
# #
